...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<!-- Проявление/скрытие схемы метро -->
		<script type="text/javascript">
			$(document).ready(function(){
				$(".metro_button").click(function(){
					$(".metro_shema").toggle(700);
				});
			});
		</script>
			...
			<div id="content">
				...
				<div class="left_text">
					<div class="bg_contacts">
						<p><b>Юридический адрес:</b><br />125040, г. Москва, Ленинградский пр-т, д.5 стр.2</p>
						<p><b style="width: 85px; display: inline-block">E-mail:</b> info@primacorline.ru<br />
						<b style="width: 85px; display: inline-block">Телефон:</b> 8-499-257-33-73, 8-499-257-33-82<br />
						<b style="width: 85px; display: inline-block">Тел./Факс:</b> 8-499-257-33-76</p>
					</div>
				</div>
				<div class="right_text">
					<div class="bg_contacts">
						<p><b>Адреса салонов:</b></p>

							<ul class="adresa">
								<li><a href="#">г. Москва, м. Белорусская, Ленинградский пр-т,</a> д.5 стр.2</li>
								<li><a href="#">г. Москва, м. Жулебино, ул. Авиаконструктора</a> Миля, д. 26</li>
								<li><a href="#">г. Москва, м. Добрынинская 4-й Добрынинский</a> пер., д.4, 5 эт. КДЦ Мединцентра при МИД РФ</li>
								<li><a href="#">г. Москва, м. Улица Подбельского, ул.</a> Лосиноостровская, д. 45, корпус 2, ФГУ «Клиническая больница» УДП РФ 1-й этаж главного корпуса</li>
							</ul>

					</div>
				</div>
				<div class="clear_div">&nbsp;</div>
				<div class="metro_button">Салоны на схеме метро</div>
				<div class="metro_shema"></div>
			</div>
			<div class="clear_div">&nbsp;</div>
		</main>
		<footer>
